...
export async function GET() {
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch keys', details: String(err) }, { status: 500 })
    }
}
...
export async function PUT(req: Request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to update key', details: String(err) }, { status: 500 })
    }
}
...
export async function DELETE(req: Request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to delete key', details: String(err) }, { status: 500 })
    }
}
