...
export async function GET() {
    ...
    const projects = await prisma.project.findMany({
        ...
        select: {
            ...
            featured: true, published: true, subtitlesPublic: true, sortOrder: true, coverImage: true, mobileCoverImage: true, mobileGallery: true,
...
export async function POST(req: Request) {
    ...
    const project = await prisma.project.create({
        data: {
            ...
            mobileGallery: body.mobileGallery || null,
