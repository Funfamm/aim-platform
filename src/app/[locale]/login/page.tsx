...
<main id="main-content" style={{
                ...
                <div style={{ width: '100%', maxWidth: '440px', position: 'relative', zIndex: 1 }}>
                    ...
                    <div style={{
                        ...
                        {/* OAuth Buttons — shown first for quick sign-in */}
                        {(providers.google || providers.apple) && (
                            <>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-sm)', marginBottom: 'var(--space-lg)' }}>
                                    {providers.google && (
                                        <a href={`/api/auth/google${redirectTo && redirectTo !== '/' ? `?returnTo=${encodeURIComponent(redirectTo)}` : ''}`} style={{
                                    ...
                                    {providers.apple && (
                                        <a href={`/api/auth/apple${redirectTo && redirectTo !== '/' ? `?returnTo=${encodeURIComponent(redirectTo)}` : ''}`} style={{
                                            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px',
                                            width: '100%', padding: '0.75rem', background: 'rgba(255,255,255,0.05)',
                                            border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-md)',
                                            color: 'var(--text-primary)', fontSize: '0.9rem', fontWeight: 600,
