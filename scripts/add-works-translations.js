// scripts/add-works-translations.js
// Run: node scripts/add-works-translations.js
// Uses UTF-8 without BOM — safe for Next.js / next-intl
...
for (const [locale, strings] of Object.entries(translations)) {
  ...
  if (!fs.existsSync(fp)) { console.warn('SKIP:', locale); continue }
  const json = JSON.parse(fs.readFileSync(fp, 'utf8'))
  json.works = strings
  // utf8 = UTF-8 without BOM — matches the KI rule
  fs.writeFileSync(fp, JSON.stringify(json, null, 2), { encoding: 'utf8' })
  console.log('OK:', locale)
  ok++
}
console.log(`\nDone — updated ${ok}/11 locale files.`)
